export const searchRandom='https://www.themealdb.com/api/json/v1/1/random.php'

export const listCategories='https://www.themealdb.com/api/json/v1/1/list.php?c=list'
...
export const searchName='https://www.themealdb.com/api/json/v1/1/search.php?s='// + name
